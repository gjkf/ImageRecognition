...
def download_images(query):
  """
  Dowloads the first page of results from Bing with the given query.

  Args:
    query: The item to search.
  ...
  for img in images:
    ...
    f = open("images/" + query + "_"+ str(cntr) + ".jpg", 'wb')
    f.write(raw_img)
    f.close()
...
def main(_):
  ...
  download_images("mountain")
  onlyfiles = [f for f in os.listdir("images/") if os.path.isfile(
      os.path.join("images/", f))]
  image = "images/" + random.choice(onlyfiles)
  print(image + "\n\n")
